...
void DoSieving(short *s, long chunksize, long k, long q, long M, long m0, long Mp, long D, unsigned long n, long ainv, long cainv) {
...
/* parameter kappa = 1/quot */
{
  ...
  for(M = K*D+1; M <=x; M+=(2*R+1)) { //unabh: M, K, D, R
    ...
    DoSieving(s, chunksize, k, q, M, m0, Mp, D, n, ainv, cainv);
