...
/// algorithm from Helfgott, returns array with values 1 in index j if n+j is a coprime
/// parallelized on the smallest iterator
#[allow(non_snake_case)]
pub fn s_par_sieve(n: usize, delta: usize, k: usize, qout: usize) -> Vec<usize>
